...
static const struct tas5713_init_command tas5713_init_sequence[] = {
	...
	/* Channel 1 bi-quad values 0-6 (also written to channel 2, see above).
         * 4th order high pass filter at 45Hz
	 */
	{ .size = 21, .data = "\x29\x00\x7F\x96\x00\x03\x00\xD4\x00\x00"
	   "\x7F\x96\x00\x00\xFF\x2B\xA8\x03\x80\xD3\xA8" },
	{ .size = 21, .data = "\x2A\x00\x7F\x96\x00\x03\x00\xD4\x00\x00"
	   "\x7F\x96\x00\x00\xFF\x2B\xA8\x03\x80\xD3\xA8" },
